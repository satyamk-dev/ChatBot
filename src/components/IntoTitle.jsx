    ...
    return (
        <>
            ...
            <div className=' flex justify-center items-center flex-col text-center bg-neutral-800 '>
                <div>
                    <h1 className='text-3xl text-white font-bold'>Hi... I'm  <span className='text-4xl font-bold text-fuchsia-600 animate-[pulse_1s_ease-in-out_3]'>Genius</span>AI.</h1><br />
